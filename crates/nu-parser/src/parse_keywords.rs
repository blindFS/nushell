...
pub fn parse_export_in_block(
    ...
    // TODO: This is for different messages of e.g. `export def --help` and `def --help`,
    // it requires an extra call of `parse_internal_call` which could be optimized in the future.
